...
export var OPENINFERENCE_HIDE_INPUTS = "OPENINFERENCE_HIDE_INPUTS";
/** Hides output value & messages */
export var OPENINFERENCE_HIDE_OUTPUTS = "OPENINFERENCE_HIDE_OUTPUTS";
/** Hides all input messages */
export var OPENINFERENCE_HIDE_INPUT_MESSAGES = "OPENINFERENCE_HIDE_INPUT_MESSAGES";
/** Hides all output messages */
export var OPENINFERENCE_HIDE_OUTPUT_MESSAGES = "OPENINFERENCE_HIDE_OUTPUT_MESSAGES";
/** Hides images from input messages */
export var OPENINFERENCE_HIDE_INPUT_IMAGES = "OPENINFERENCE_HIDE_INPUT_IMAGES";
/** Hides text from input messages */
export var OPENINFERENCE_HIDE_INPUT_TEXT = "OPENINFERENCE_HIDE_INPUT_TEXT";
/** Hides text from output messages */
export var OPENINFERENCE_HIDE_OUTPUT_TEXT = "OPENINFERENCE_HIDE_OUTPUT_TEXT";
/** Hides embedding vectors */
export var OPENINFERENCE_HIDE_EMBEDDING_VECTORS = "OPENINFERENCE_HIDE_EMBEDDING_VECTORS";
/** Limits characters of a base64 encoding of an image */
export var OPENINFERENCE_BASE64_IMAGE_MAX_LENGTH = "OPENINFERENCE_BASE64_IMAGE_MAX_LENGTH";
export var DEFAULT_HIDE_INPUTS = false;
export var DEFAULT_HIDE_OUTPUTS = false;
export var DEFAULT_HIDE_INPUT_MESSAGES = false;
export var DEFAULT_HIDE_OUTPUT_MESSAGES = false;
export var DEFAULT_HIDE_INPUT_IMAGES = false;
export var DEFAULT_HIDE_INPUT_TEXT = false;
export var DEFAULT_HIDE_OUTPUT_TEXT = false;
export var DEFAULT_HIDE_EMBEDDING_VECTORS = false;
export var DEFAULT_BASE64_IMAGE_MAX_LENGTH = 32000;
/** When a value is hidden, it will be replaced by this redacted value */
export var REDACTED_VALUE = "__REDACTED__";
/**
 ...
 */
export var traceConfigMetadata = {
    hideInputs: {
