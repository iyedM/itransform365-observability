...
const constants_1 = require("../../src/trace/trace-config/constants");
const OISpan_1 = require("../../src/trace/trace-config/OISpan");
describe("OISpan", () => {
    describe("OISpan", () => {
        let mockSpan;
        beforeEach(() => {
        ...
        it("should delegate all methods to the span", () => {
            const openInferenceSpan = new OISpan_1.OISpan({
                span: mockSpan,
                config: constants_1.DefaultTraceConfig,
            });
        ...
        describe("setAttribute", () => {
            it("should mask sensitive attributes", () => {
                const openInferenceSpan = new OISpan_1.OISpan({
                    span: mockSpan,
                    config: Object.assign(Object.assign({}, constants_1.DefaultTraceConfig), { hideInputs: true }),
                });
                openInferenceSpan.setAttribute("input.value", "sensitiveValue");
                expect(mockSpan.setAttribute).toHaveBeenCalledWith("input.value", constants_1.REDACTED_VALUE);
            });
        ...
        describe("setAttributes", () => {
            it("should mask sensitive attributes in bulk", () => {
                ...
                expect(mockSpan.setAttributes).toHaveBeenCalledWith({
                    "input.value": constants_1.REDACTED_VALUE,
                    normalKey: "normalValue",
                });
            });
        });
...
//# sourceMappingURL=OpenInferenceSpan.test.js.map